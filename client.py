...
'''app.config['SQLALCHEMY_DATABASE_URI'] =\
        'mysql://student:yiJmf7G9kiQ7Vth**@localhost:3306/mikrotik'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False '''
...
SERVER_CERT_PATH_DEFAULT = "/home/student/Plocha/projekt/sentinel/dynfw-example-client/dynfw.pub"
...
class Ipaddresses(db.Model):
    ...
    ipaddress = db.Column(db.String(15), nullable=False, default='0.0.0.0')
